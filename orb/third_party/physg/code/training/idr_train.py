...
class IDRTrainRunner():
    def __init__(self,**kwargs):
        ...
        with open(os.path.join(self.expdir, self.timestamp, 'trainer_kwargs.json'), 'w') as f:
        ...
        self.train_dataset = utils.get_class(self.conf.get_string('train.dataset_class'))(gamma=kwargs['gamma'],
        ...
        self.plot_dataset = utils.get_class(self.conf.get_string('train.dataset_class'))(gamma=kwargs['gamma'],
                                                                                         exposure=kwargs['exposure'],
                                                                                         instance_dir=kwargs['data_split_dir'],
                                                                                         train_cameras=self.train_cameras,
                                                                                         split='train')
