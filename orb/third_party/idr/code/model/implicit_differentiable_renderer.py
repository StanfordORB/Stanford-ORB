...
class IDRNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        if differentiable_surface_points.shape[0] > 0:
            rgb_values[surface_mask], normal_values[surface_mask] = self.get_rbg_value(differentiable_surface_points, view, return_normals=True)
    ...
    def get_rbg_value(self, points, view_dirs, return_normals=False):
