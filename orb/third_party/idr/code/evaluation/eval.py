...
def evaluate(**kwargs):
    ...
    with torch.no_grad():
        ...
        if 'eval_shape' in kwargs and kwargs['eval_shape']:
            ...
            # c2w = eval_dataset[0][1]['pose'].numpy()
            # w2c = np.linalg.inv(c2w)
            # mesh_clean.apply_transform(w2c)
            # mesh_clean.export('{0}/surface_camera_coordinates_{1}.ply'.format(evaldir, epoch), 'ply')
