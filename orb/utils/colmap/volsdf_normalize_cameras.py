...
def normalize_cameras(original_cameras_filename,output_cameras_filename,num_of_cameras):
    if isinstance(original_cameras_filename, str):
        ...
        cameras = original_cameras_filename
    cameras_new = _normalize_cameras(cameras, num_of_cameras)
    np.savez(output_cameras_filename, **cameras_new)

def _normalize_cameras(cameras, num_of_cameras):
    ...
    print('VolSDF normalization', normalization)
